...
// bbfm->GetChordFinder()->SetDeltaChord(1.0*um);
 ...
 // GEM option 4
  ...
  // double gemw_opt4[];
  // double gemh_opt4[];
   double gemz_opt4[] = { 0.0*cm, gemdsep, gemdsep*2.0,gemdsep*3.0, gemdsep*4.0,gemdsep*5.0,gemdsep*6.0, gemdsep*7.0,gemdsep*8.0, gemdsep*9.0};
   double gemw_opt4[] = { 40.0*cm, 50.0*cm, 50.0*cm,50.0*cm, 50.0*cm,40.0*cm, 50.0*cm, 50.0*cm,50.0*cm, 50.0*cm};
   double gemh_opt4[] = { 150.0*cm, 200.0*cm, 200.0*cm, 200.0*cm, 200.0*cm,150.0*cm, 200.0*cm, 200.0*cm, 200.0*cm, 200.0*cm};
...
//  G4SubtractionSolid* bigcoil_full = new G4SubtractionSolid("bigcoil_full", bigcoilbase, bigcoilgap);
  ...
  double hcalr = fHCALdist+hcaldepth/2.0-5*m;
